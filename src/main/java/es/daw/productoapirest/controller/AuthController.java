...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> register(@Valid @RequestBody RegisterRequest request) {
        ...
        //PENDIENTE!! TODO y si se envían roles duplicados???
        //3. buscar el rol en la BDD
        ...
        //response.addDetail("roles", newUser.getRoles().stream().map(Role::getName).toList());
    ...
    //TODO mejoras!!!
    //1. crear un authservice y quitar la lógica de este endpoint (repository etc...)
