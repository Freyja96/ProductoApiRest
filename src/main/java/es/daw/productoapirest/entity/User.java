...
public class User implements UserDetails {
    ...
    //Relación bidireccional porque el usuario es el lado propietario, porque tiene la tabla intermedia
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return roles.stream()
                ...
                //.map (role -> (GrantedAuthority) () -> "ROLE_"+role.getName()) // si no lo tuviéramos en la base de datos
